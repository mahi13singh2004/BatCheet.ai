...
const Spinner = () => {
  return (
    <>
      <div
        role="status"
        className="fixed inset-0 flex flex-col justify-center items-center bg-gradient-to-br from-[#000106] via-[#1a1f3a] to-[#000106] z-[9999] animate-shimmer backdrop-blur-sm"
      >
        <div className="relative animate-float">
          ...
          <div
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8 border-4 border-transparent border-t-purple-400 border-r-pink-500 border-b-cyan-500 rounded-full animate-spin"
        ...
        <div
          className="mt-8 text-center animate-float"
        ...
        >
          ...
          <p
            className="text-gray-600 text-sm mt-3 animate-pulse"
        ...
        <div
          className="absolute top-3/4 right-1/4 w-1 h-1 bg-purple-400 rounded-full animate-pulse opacity-40"
          style={{ animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute bottom-1/4 left-1/3 w-1 h-1 bg-pink-400 rounded-full animate-pulse opacity-40"
          style={{ animationDelay: "1s" }}
        ></div>
